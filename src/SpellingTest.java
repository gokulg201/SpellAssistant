...
public class SpellingTest {
	 static  Spelling spellfixer;
	    ...
	    public static void main(String[] args) throws Exception {
	        ...
	        File textFile = new File("/Users/gokul-4406/Downloads/big.txt");
//	        spellfixer = new Spelling(Paths.get(textFile.getAbsolutePath()));
	        spellfixer = new Spelling("/Users/gokul-4406/Downloads/big.txt");
